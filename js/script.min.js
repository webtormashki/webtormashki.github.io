$(document).ready(function(){
	...
	$('a[data-rel]').each(function() {
	 ...
	 $('a.post').each(function(){
		$(this).append('<div class="gridHover"><p>Перейти к публикации</p></div>');
		$(this).hover(function(){
			$(this).find('div.gridHover').stop().css('display', 'block').animate({'opacity': 0}, 0).animate({'opacity': 1}, 300);
		}, function(){
			$(this).find('div.gridHover').stop().fadeOut(400);
...
$('.socialIcons li a').each(function(){
	...
	$(this).addClass('socialHover').css('backgroundPosition', $(this).css('backgroundPosition').slice(0, $(this).css('backgroundPosition').indexOf('px'))+'px -32px');
